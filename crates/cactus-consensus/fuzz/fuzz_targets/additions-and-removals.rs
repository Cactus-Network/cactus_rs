...
use cactus_consensus::gen::additions_and_removals::additions_and_removals;
use cactus_consensus::gen::flags::{ALLOW_BACKREFS, DONT_VALIDATE_SIGNATURE};
use cactus_consensus::gen::run_block_generator::run_block_generator2;
use cactus_protocol::{Bytes, Coin};
