...
use cactus_py_streamable_macro::{PyGetters, PyJsonDict, PyStreamable};
use hex_literal::hex;

#[cfg_attr(
    feature = "py-bindings",
    pyo3::pyclass(module = "cactus_rs"),
...
pub struct ConsensusConstants {
    ...
    /// Forks of cactus should change these values to provide replay attack protection.
