...
pub enum ErrorCode {
    ...
    // InitialTransactionFreeze (removed in `cactus-blockchain` as well)
...
// from cactus-blockchain/cactus/util/errors.py
impl From<ErrorCode> for u32 {
    fn from(err: ErrorCode) -> u32 {
        match err {
            ...
            // ErrorCode::InitialTransactionFreeze => 107 (removed in `cactus-blockchain`` as well)
