...
use cactus_protocol::{Bytes32, Coin};
...
/// This is the puzzle reveal of the [CAT2 standard](https://cactuslisp.com/cats) puzzle.
...
/// This is the puzzle hash of the [CAT2 standard](https://cactuslisp.com/cats) puzzle.
...
/// This is the puzzle reveal of the [CAT2 multi-issuance TAIL](https://cactuslisp.com/cats#multi) puzzle.
...
/// This is the puzzle hash of the [CAT2 multi-issuance TAIL](https://cactuslisp.com/cats#multi) puzzle.
...
/// This is the puzzle reveal of the [CAT2 single-issuance TAIL](https://cactuslisp.com/cats/#single) puzzle.
...
/// This is the puzzle hash of the [CAT2 single-issuance TAIL](https://cactuslisp.com/cats/#single) puzzle.
...
/// This is the puzzle reveal of the old [CAT1 standard](https://cactuslisp.com/cats) puzzle.
///
/// **Warning:**
...
/// of CAT2 in the [CATbleed Post Mortem](https://github.com/Cactus-Network/post-mortem/blob/main/2022-08/2022-08-19-CATbleed.md).
...
/// This is the puzzle hash of the old [CAT1 standard](https://cactuslisp.com/cats) puzzle.
///
/// **Warning:**
/// It is recommended not to use CAT1 for anything other than backwards compatibility (e.g. offer compression),
/// due to security issues uncovered in an audit. You can read more about the vulnerability that prompted the creation
