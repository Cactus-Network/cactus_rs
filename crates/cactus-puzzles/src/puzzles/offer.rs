use cactus_protocol::{Bytes, Bytes32};
...
/// This is the puzzle reveal of the [offer settlement payments](https://cactuslisp.com/offers) puzzle.
...
/// This is the puzzle hash of the [offer settlement payments](https://cactuslisp.com/offers) puzzle.
...
/// This is the puzzle reveal of the old [offer settlement payments](https://cactuslisp.com/offers) puzzle.
///
/// **Warning:**
...
/// This is the puzzle hash of the old [offer settlement payments](https://cactuslisp.com/offers) puzzle.
///
/// **Warning:**
/// It is recommended not to use settlement payments v1 for anything other than backwards compatibility (e.g. offer compression).
