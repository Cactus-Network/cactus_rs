...
/// This is the puzzle reveal of the [standard transaction](https://cactuslisp.com/standard-transactions) puzzle.
...
/// This is the puzzle hash of the [standard transaction](https://cactuslisp.com/standard-transactions) puzzle.
...
/// This is the puzzle reveal of the [default hidden puzzle](https://cactuslisp.com/standard-transactions#default-hidden-puzzle).
pub const DEFAULT_HIDDEN_PUZZLE: [u8; 3] = hex!("ff0980");

/// This is the puzzle hash of the [default hidden puzzle](https://cactuslisp.com/standard-transactions#default-hidden-puzzle).
