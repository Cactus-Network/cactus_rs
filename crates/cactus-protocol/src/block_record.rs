...
impl BlockRecord {
    ...
    // cactus.consensus.pot_iterations to rust, and make this less hacky
    ...
    fn sp_iters_impl(&self, py: Python<'_>, constants: &Bound<'_, PyAny>) -> PyResult<u64> {
        ...
        py.run_bound(
            "from cactus.consensus.pot_iterations import calculate_ip_iters, calculate_sp_iters\n\
    ...
    fn sp_sub_slot_total_iters<'a>(
        ...
        CactusToPython::to_python(&self.sp_sub_slot_total_iters_impl(py, constants)?, py)
    }
    ...
    fn ip_sub_slot_total_iters<'a>(
        ...
        CactusToPython::to_python(&self.ip_sub_slot_total_iters_impl(py, constants)?, py)
    }
    ...
    fn sp_iters<'a>(
        ...
        CactusToPython::to_python(&self.sp_iters_impl(py, constants)?, py)
    }
    ...
    fn ip_iters<'a>(
        ...
        CactusToPython::to_python(&self.ip_iters_impl(py, constants)?, py)
    }
    ...
    fn sp_total_iters<'a>(
        ...
        CactusToPython::to_python(&self.sp_total_iters_impl(py, constants)?, py)
    }
}
