...
use cactus_consensus::consensus_constants::TEST_CONSTANTS;
use cactus_consensus::gen::conditions::{NewCoin, SpendBundleConditions, SpendConditions};
use cactus_consensus::gen::flags::{ALLOW_BACKREFS, DONT_VALIDATE_SIGNATURE, MEMPOOL_MODE};
use cactus_consensus::gen::run_block_generator::{run_block_generator, run_block_generator2};
use cactus_tools::iterate_blocks;
...
/// Analyze the blocks in a cactus blockchain database
#[derive(Parser, Debug)]
