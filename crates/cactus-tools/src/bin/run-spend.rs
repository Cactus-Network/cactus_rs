use cactus_consensus::gen::conditions::Condition;
use cactus_puzzles::Proof;
...
use cactus_puzzles::cat::{CatArgs, CatSolution, CAT_PUZZLE_HASH};
use cactus_puzzles::did::{DidArgs, DidSolution, DID_INNER_PUZZLE_HASH};
use cactus_puzzles::singleton::{SingletonArgs, SingletonSolution, SINGLETON_TOP_LAYER_PUZZLE_HASH};
use cactus_puzzles::standard::{StandardArgs, StandardSolution, STANDARD_PUZZLE_HASH};
...
fn main() {
    use cactus_consensus::gen::conditions::parse_args;
    use cactus_consensus::gen::opcodes::parse_opcode;
