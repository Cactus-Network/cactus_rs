...
pub fn py_streamable_macro(input: proc_macro::TokenStream) -> proc_macro::TokenStream {
    ...
    let mut py_protocol = quote! {
        ...
        impl #crate_name::CactusToPython for #ident {
    ...
    let streamable = quote! {
        ...
        impl #ident {
            ...
            pub fn py_from_bytes_unchecked(cls: &pyo3::Bound<'_, pyo3::types::PyType>, py: pyo3::Python<'_>, blob: pyo3::buffer::PyBuffer<u8>) -> pyo3::PyResult<pyo3::PyObject> {
                ...
                let rust_obj = Bound::new(py, <Self as #crate_name::Streamable>::from_bytes_unchecked(slice).map_err(|e| <#crate_name::cactus_error::Error as Into<pyo3::PyErr>>::into(e))?)?;
            ...
            pub fn parse_rust<'p>(cls: &pyo3::Bound<'_, pyo3::types::PyType>, py: pyo3::Python<'_>, blob: pyo3::buffer::PyBuffer<u8>, trusted: bool) -> pyo3::PyResult<(pyo3::PyObject, u32)> {
                ...
                let rust_obj = if trusted {
                    <Self as #crate_name::Streamable>::parse::<true>(&mut input).map_err(|e| <#crate_name::cactus_error::Error as Into<pyo3::PyErr>>::into(e)).map(|v| (v, input.position() as u32))
                } else {
                    <Self as #crate_name::Streamable>::parse::<false>(&mut input).map_err(|e| <#crate_name::cactus_error::Error as Into<pyo3::PyErr>>::into(e)).map(|v| (v, input.position() as u32))
                }?;
            ...
            pub fn get_hash<'p>(&self, py: pyo3::Python<'p>) -> pyo3::PyResult<pyo3::Bound<'p, pyo3::types::PyAny>> {
                ...
                use pyo3::prelude::PyAnyMethods;
                let mut ctx = cactus_sha2::Sha256::new();
                #crate_name::Streamable::update_digest(self, &mut ctx);
                let bytes_module = PyModule::import_bound(py, "cactus_rs.sized_bytes")?;
            ...
            pub fn py_to_bytes<'p>(&self, py: pyo3::Python<'p>) -> pyo3::PyResult<pyo3::Bound<'p, pyo3::types::PyBytes>> {
                ...
                #crate_name::Streamable::stream(self, &mut writer).map_err(|e| <#crate_name::cactus_error::Error as Into<pyo3::PyErr>>::into(e))?;
        ...
        let pickle = quote! {
            ...
            impl #ident {
                ...
                pub fn __getnewargs__<'py>(&self, py: pyo3::Python<'py>) -> pyo3::PyResult<pyo3::Bound<'py, pyo3::types::PyTuple>> {
                    ...
                    #( args.push(#crate_name::CactusToPython::to_python(&self.#fnames, py)?); )*
    ...
    let ret = quote! {
        ...
        impl #ident {
            ...
            fn #fnames_maybe_upper<'a> (&self, py: pyo3::Python<'a>) -> pyo3::PyResult<pyo3::Bound<'a, pyo3::PyAny>> {
                #crate_name::CactusToPython::to_python(&self.#fnames, py)
            }
            )*
        }
    };
